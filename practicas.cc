...
//***************************************************************************
// Funcion llamada cuando no hay eventos
//
// El evento activa la animación de la escena
//
//***************************************************************************
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: IGNACIO YUSTE LOPEZ (ignacioyustel@correo.ugr.es)");
   ...
   glutSpecialFunc( special_keys );
	...
	// asignacion de la funcoin llamada "funcion_idle" al evento correspondiente
